<template>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#000F9C">
        <path
            ...
            font-weight="400" font-family="sans-serif" white-space="normal" overflow="visible" fill="#000F9C" />
    </svg>
</template>